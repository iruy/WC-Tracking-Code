...
Installing "WC Tracking code" can be done either by searching for "WC Tracking code" via the "Plugins > Add New" screen in your WordPress dashboard, or by using the following steps:
